...
final class LocationPickerViewController: UIViewController {
    ...
    public var regionRetrieved: MKCoordinateRegion?
...
//        let coordinate: CLLocationCoordinate2D = CLLocationCoordinate2DMake(37.99472919902424, -95.85629270877689)
...
//        let region = MKCoordinateRegion(center: coordinate, span: span)
	...
	func setInitialLocation() {
		if let location = location {
            ...
            print("else if showcurrentlocation")
...
extension LocationPickerViewController: UISearchResultsUpdating {
    ...
    @objc func searchFromTimer(_ timer: Timer) {
		...
		if let location = locationManager.location, useCurrentLocationAsHint {
            print("usecurrentlocationashit region")
...
//        request.region = MKCoordinateRegion(center: coordinate, span: span)
        request.region = regionRetrieved!
